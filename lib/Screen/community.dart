                  ...
                  onTap: () {
                    if (article.url.isNotEmpty) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('No full article available.')),
                      );
                    }
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Color.fromARGB(255, 231, 251, 249),
                    ),
                    padding: EdgeInsets.only(right: 10),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Category', // You might want to derive this from the article or another source
                                      style: TextStyle(
                                        fontFamily: 'Poppins',
                                        fontSize: 14,
