...
Future<void> main() async {
  ...
  // Clear SharedPreferences (temporary fix for quiz cache issue)
  final prefs = await SharedPreferences.getInstance();
  await prefs.remove('quizCache');
print('Quiz cache cleared, but auth tokens remain intact');
  print('SharedPreferences cleared on app startup');
