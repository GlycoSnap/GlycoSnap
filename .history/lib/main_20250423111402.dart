...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      // Remove home to avoid premature AuthWrapper instantiation
    );
  }
}
...
class AuthWrapper extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // For development: Clear session to prevent auto-login
    ...
    if (session == null) {
      return const Login(); // Or const Slides() for onboarding
    } else {
