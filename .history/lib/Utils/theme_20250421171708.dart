...
class AppTheme {
  ...
  static const Color lightOnPrimary = Color.fromARGB(255, 0, 154, 181);
  static const Color lightOnSecondary = Color(0xffFFFFFF);
  static const Color lightError = Color.fromARGB(255, 255, 0, 0);

  // Dark Theme Colors
  static  Color darkPrimary = colorLight2;
  static  Color darkSecondary = colorDark;
  static const Color darkSurface = Color(0xff000000);
  static const Color darkSurfaceContainer = Color(0xff0C3B60);
  static const Color darkOnSurface = Color(0xffFFFFFF);
  static const Color darkOnPrimary = colorLight2;
