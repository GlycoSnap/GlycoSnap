...
class AppTheme {
  // Light Theme Colors
  static const Color lightPrimary = Color(0xff47B2A5);
  static const Color lightSecondary = Color(0xff48cae4);
  ...
  static const Color darkSurface = Color.fromARGB(255, 6, 39, 64);
