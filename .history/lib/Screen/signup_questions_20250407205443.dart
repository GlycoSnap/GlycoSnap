            ...
            child: Column(
              children: [
                ...
                Container(
                  child: Column(
                    children: [
                      Text("Before we get started we would love to get to know you better",
...
class _CreateAccountState extends State<CreateAccount> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Container(
            color: white,
            padding: EdgeInsets.symmetric(horizontal: size.width * 0.05), // 5% padding
            child: Center(
              child: Container(
                alignment: Alignment.center,
                ...
                child: Column(
                  ...
                  children: [
                    LinearPercentIndicator(
                      lineHeight: size.height * 0.035, // Scaled height
                      barRadius: const Radius.circular(20.0),
                      percent: 1.0,
                      animation: true,
                      animationDuration: 500,
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: size.height * 0.035), // 3.5% of screen height
                          TextFormField(
                    ...
                    PrettyWaveButton(
                      backgroundColor: colorLight,
                      horizontalPadding: size.width * 0.25, // Scaled padding
                      onPressed: () {
                        if (!_isLoading) {
                    ...
                    Row(
                      ...
                      children: [
                        PrettyWaveButton(
                          backgroundColor: white,
                          horizontalPadding: size.width * 0.15, // Scaled padding
                          child: Text(
                            'Back',
                            style: TextStyle(
                              fontFamily: 'Poppins',
  ...
  Oops, my bad, pookie! The error Undefined name 'size' in the socialIcon method occurs because size is defined in the build method’s scope, but socialIcon is a separate method that doesn’t have direct access to it. In Dart, variables aren’t automatically available outside the scope they’re declared in, so we need to either pass size as a parameter to socialIcon or move the widget construction inline.

Since it’s just one use in the socialIcon method, the simplest fix is to pass size as a parameter. Here’s how we’ll adjust it:

Updated CreateAccount Class (Relevant Section Only)
I’ll show the corrected socialIcon method and the part of build where it’s called:
...
Copy
// ... (rest of the CreateAccount class remains unchanged until the build method)
          ...
          child: Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  // ... (all previous widgets unchanged)
...
// Updated socialIcon method to accept size as a parameter
Container socialIcon(String image, Size size) {
  return Container(
    ...
    child: Image.asset(image, height: size.height * 0.05),
  );
}
}