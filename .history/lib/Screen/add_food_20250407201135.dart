  ...
  return Scaffold(
    ...
    body: SafeArea(
      child: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: size.width * 0.05), // 5% padding on sides
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          child: Text(
                            'Open Camera',
                            style: TextStyle(fontSize: size.width * 0.04), // Scaled font size
                          ),
                        ),
                      ],
                    ),
              ...
              if (_imageFile != null)
                Padding(
                  padding: EdgeInsets.only(top: size.height * 0.02), // 2% of screen height
                  child: Image.file(
                    _imageFile!,
                    width: size.width * 0.9, // 90% of screen width
              ...
              ElevatedButton(
                style: ButtonStyle(
                  backgroundColor: const WidgetStatePropertyAll(Color(0xff0C3B60)),
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          final data = snapshot.data!;
                              ...
                              data['glycemic_load_category']?.toString() ?? 'Unknown';
                          Color categoryColor;
                          ...
                          } else if (glycemicLoadCategory == 'High glycemic load') {
                          ...
                          final glycemicLoad = data['glycemic_load'] is Map<String, dynamic>
                          ...
                          return Column(
                            ...
                            children: [
                              Container(
                                ...
                                padding: EdgeInsets.all(size.width * 0.03), // 3% padding
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ...glycemicLoad.entries.map((entry) {
                                        final value = (entry.value as num?)?.toStringAsFixed(2) ?? 'N/A';
                                        return Padding(
                                          padding: EdgeInsets.symmetric(vertical: size.height * 0.005), // Scaled padding
                                          child: Text(
                                            '${entry.key}: $value',
                                            style: TextStyle(
                                              fontFamily: 'Poppins',
                                      ...
                                      RichText(
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text: totalGL.toStringAsFixed(2),
                                              style: TextStyle(
                                                fontFamily: 'PoppinsBold',
                                                fontSize: size.width * 0.04, // Scaled font size
                                                color: categoryColor,
