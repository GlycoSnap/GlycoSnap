...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    appBar: AppBar(
      ...
      actions: [
        Padding(
          padding: EdgeInsets.only(right: size.width * 0.05), // 5% of screen width
          child: IconButton(
            onPressed: () {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '😊',
                    style: TextStyle(fontSize: size.width * 0.06), // Scaled emoji size
                  ),
                ],
              ),
                    ...
                    children: [
                      Positioned(
                        ...
                        child: CircularPercentIndicator(
                          ...
                          percent: (calculateTotalGlycemicLoad(mealProvider.breakfast) / 100)
                              .clamp(0.0, 1.0),
                      ...
                      Positioned(
                        ...
                        child: CircularPercentIndicator(
                          ...
                          progressColor: const Color.fromARGB(255, 0, 154, 181),
                          backgroundColor: Colors.white,
                          circularStrokeCap: CircularStrokeCap.round,
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Container(
                                  width: size.width * 0.05, // Scaled circle size
                                  height: size.width * 0.05, // Scaled circle size
                                ...
                                Padding(
                                  padding: EdgeInsets.only(left: size.width * 0.015), // Scaled padding
                                  child: Text(
                                    'Glycemic Load',
                                    style: TextStyle(
                                      fontFamily: 'OpenSauce',
              ...
              // Breakfast
              SizedBox(height: size.height * 0.02), // 2.5% of screen height
              ClipRRect(
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Row(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(left: size.width * 0.04), // 4% of screen width
                          child: Container(
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: size.width * 0.08), // 8% of screen width
                          child: Text(
                            'Breakfast',
                            style: TextStyle(
                              fontFamily: 'Poppins',
                        ...
                        child: ListView(
                          children: mealProvider.breakfast.map((meal) {
                            ...
                            return Container(
                              ...
                              padding: EdgeInsets.all(size.width * 0.025), // Scaled padding
                              decoration: BoxDecoration(
                                color: white,
