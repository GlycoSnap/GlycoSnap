        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.camera_alt), // Camera icon at start
              suffixIcon: const Icon(Icons.send), // Send icon at end
              filled: true,
              fillColor: white,
              labelStyle: TextStyle(color: white),
              enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(color: white.withValues(0.5)),
              ),
              focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(color: colorLight2),
              ),
            ),
