...
class _AddFoodState extends State<AddFood> with SingleTickerProviderStateMixin {
  ...
  final String baseUrl =
      'http://192.168.145.159:5000/predict'; //Replace with your Flask server URL
        ...
        children: [
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
                horizontal: size.width * 0.06), // 5% padding on sides
            child: Column(
              ...
              children: [
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                  width:
                                      size.width * 0.01), // 3% of screen width
                              Text(
                ...
                if (_imageFile != null)
                  Padding(
                    ...
                    child: Image.file(
                      _imageFile!,
                      width: size.width * 0.6, // 90% of screen width
                  ...
                  style: ButtonStyle(
                    ...
                    padding: WidgetStatePropertyAll(
                      EdgeInsets.symmetric(
                        horizontal: size.width * 0.05, // 10% of screen width
                ...
                _glycemicLoadFuture == null
                    ...
                    : FutureBuilder<Map<String, dynamic>>(
                            ...
                            return Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  height:
                                      size.height * 0.25, // 30% of screen height
                                  decoration: BoxDecoration(
                      ...
                      SizedBox(height: size.height * 0.03), // 1.5% of screen height
              ],
            ),
