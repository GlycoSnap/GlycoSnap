...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  child: CircularPercentIndicator(
    key: ValueKey(calculateTotalGlycemicLoad(mealProvider.breakfast)),
    animation: true,
    animationDuration: 1000, // Reduce duration for smoother updates
    radius: size.width * 0.18,
    lineWidth: size.width * 0.03,
    percent: (calculateTotalGlycemicLoad(mealProvider.breakfast) / 100).clamp(0.0, 1.0),
    progressColor: const Color(0xff071332),
    backgroundColor: Colors.white,
    circularStrokeCap: CircularStrokeCap.round,
    center: Text(
      "${(calculateTotalGlycemicLoad(mealProvider.breakfast)).toStringAsFixed(1)}",
      style: TextStyle(
        fontFamily: 'OpenSauce',
