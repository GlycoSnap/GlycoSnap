...
class _LoginState extends State<Login> {
  ...
  void initState() {
    super.initState();
    // Force-clear any stale session so AuthWrapper sends you here
  ...
  Future<void> _signInWithEmailAndPassword() async {
    ...
    try {
      ...
      // Ensure we got a valid session & user
      ...
      // Supabase errors (wrong credentials, unconfirmed email, etc.)
      Get.snackbar(
        'Login Error',
        error.message,
        snackPosition: SnackPosition.BOTTOM,
          ...
          child: ListView(
            children: [
              ...
              PrettyWaveButton(
                ...
                // ALWAYS a non-null callback; we disable via the _isLoading flag
                onPressed: () {
