    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          ...
          'total_glycemic_load':
              data['total_glycemic_load'] ?? 0.0, // Ensure default value
          'glycemic_load_category': data['glycemic_load_category'] ??
              'Unknown', // Ensure default value
          'food_name':
              data['food_name'] ?? 'Unknown Food', // Ensure default value
        };
      } else {
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                              ...
                              final glycemicLoadCategory =
                                  data['glycemic_load_category'] ?? 'Unknown';
                              Color categoryColor;
