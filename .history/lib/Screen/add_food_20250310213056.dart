...
class _AddFoodState extends State<AddFood> {
  ...
  final String baseUrl =
      'http://192.168.0.100:5000/predict'; // Replace with your Flask server URL
  ...
  builder: (context, snapshot) {
    if (snapshot.connectionState == ConnectionState.waiting) {
      ...
      // Create a widget to display glycemic load results,
      // depending on the type of data['glycemic_load']
      Widget glycemicLoadWidget;
      if (data['glycemic_load'] is Map<String, dynamic>) {
        glycemicLoadWidget = Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: (data['glycemic_load'] as Map<String, dynamic>)
              .entries
              .map((entry) {
            return Padding(
      ...
      } else if (data['glycemic_load'] is num) {
        glycemicLoadWidget = Text(
          "Glycemic Load: ${(data['glycemic_load'] as num).toStringAsFixed(2)}",
          style: const TextStyle(
            fontFamily: 'Poppins',
            fontSize: 15,
            color: Colors.black,
        ...
        glycemicLoadWidget =
            const Text("No glycemic load data available");
      }
      ...
      return Column(
        ...
        children: [
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: (data['total_glycemic_load'] as num)
                              .toStringAsFixed(2),
                          style: TextStyle(
                            fontFamily: 'PoppinsBold',
                            fontSize: 16,
          ...
          ElevatedButton(
            onPressed: () {
              final foodName =
                  data['food_name']?.toString() ?? 'Unknown Food';
              final totalGL =
                  (data['total_glycemic_load'] as num).toDouble();
