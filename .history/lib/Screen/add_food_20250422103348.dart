...
class _AddFoodState extends State<AddFood> with SingleTickerProviderStateMixin {
  ...
  final String baseUrl = 'http://192.168.145.159:5000/predict'; // Flask server URL
...
void _addMeal(BuildContext context, String mealType, String foodName, double glycemicLoad) {
  final meal = Meal(name: foodName, glycemicLoad: glycemicLoad);
  final mealProvider = Provider.of<MealProvider>(context, listen: false);
  mealProvider.addMeal(mealType, meal).then((_) {
    ScaffoldMessenger.of(context).showSnackBar(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Failed to add meal: ${e.toString().replaceFirst('Exception: Failed to add meal: ', '')}'),
