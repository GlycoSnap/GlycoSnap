        ...
        children: [
          ...
          Stack(
            ...
            children: [
              // Glowing circle
              Container(
                width: size.height * 0.35, // Slightly larger than bot image
                height: size.height * 0.35,
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: colorLight2.withValues(alpha: 0.2), // Semi-transparent glow
                  boxShadow: [
                    BoxShadow(
                      color: colorLight2.withValues(alpah: 0.5), // Glow color
                      blurRadius: 20,
                      spreadRadius: 10,
                    ),
                  ],
