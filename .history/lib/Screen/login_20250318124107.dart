                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(text: "Not a member? ",
                          style: TextStyle(color: colorDark, fontWeight: FontWeight.w300, fontSize: 16)),
                      TextSpan(text: "Register now",
                          style: TextStyle(fontWeight: FontWeight.bold, color: colorLight, fontSize: 16))
                    ],
                  ),
                ),
              ),
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Container(height: 3, width: size.width * 0.17, color: Colors.black12),
