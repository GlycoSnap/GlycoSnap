...
class _ChatPageState extends State with TickerProviderStateMixin {
  ...
  final String apiUrl = const String.fromEnvironment('FASTAPI_URL',
      defaultValue: 'http://192.168.145.159:8000');
      ...
      body: Column(
        children: [
                  ...
                  return Padding(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isQuery
                              ? colorDark2.withValues(alpha: 1.2)
                            ...
                            if (message['text']!.isNotEmpty)
                              MarkdownBody(
                                ...
                                styleSheet: MarkdownStyleSheet(
                                  p: TextStyle(
                                    color: isQuery ? Colors.white : white,
                                    fontSize: size.width * 0.04,
                                  ),
                                  // Optional: Customize other Markdown styles
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: colorDark.withValues(alpha: 0.8),
            ...
            child: SafeArea(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                      height: size.height *
                          0.01), // Adds spacing between text and text field
                  TextField(
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: white.withValues(
                       alpha: 0.5 + (0.5 * ((_animation.value + index / 3) % 1))),
                  ),
                );
              },
            ),
