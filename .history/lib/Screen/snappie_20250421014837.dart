...
Future _pickImage() async { 
  ...
  if (image != null) { 
    setState(() { 
      ...
      //image = null; }); // Scroll to the latest message WidgetsBinding.instance.addPostFrameCallback(() { _scrollController.jumpTo(_scrollController.position.maxScrollExtent); }); } }
