...
class _ChatPageState extends State<ChatPage> {
  ...
  final List<Map<String, String>> _messages = []; // List to store queries and responses
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                          ...
                          return Padding(
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isQuery
                                      ? colorLight2.withValues(alpha: 0.8)
          ...
          Container(
            padding: EdgeInsets.fromLTRB(size.width * 0.03, 0, size.width * 0.03, size.height * 0.02)
            decoration: BoxDecoration(
              color: colorDarkest,
