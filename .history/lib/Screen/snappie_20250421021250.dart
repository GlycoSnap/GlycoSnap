...
// Function to send text query to backend Future _sendTextQuery() async { if (_controller.text.isEmpty) { return; // Silently ignore empty queries } setState(() { _messages.add({ 'type': 'query', 'text': _controller.text, }); _isLoading = true; _controller.clear(); }); _scrollToBottom();