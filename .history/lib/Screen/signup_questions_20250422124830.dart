      ...
      if (userCredential.user != null) {
        ...
        try {
          await Supabase.instance.client.auth.signInWithIdToken(
            provider: supabase.OAuthProvider.firebase,
            idToken: await user.getIdToken(),
          );
        } catch (e) {
          print('Supabase auth sync error: $e');
          Get.snackbar('Warning', 'Failed to sync Supabase auth: $e',
              snackPosition: SnackPosition.BOTTOM);
          // Proceed despite Supabase auth failure, as profile can still be saved
        }
