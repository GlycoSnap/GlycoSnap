              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: size.height * 0.025), // 3.5% of screen height
                          TextFormField(
                    ...
                    SizedBox(height: size.height * 0.020), // 3.5% of screen height
                    Row(
  ...
  Container socialIcon(String image, Size size) { // Added size parameter
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: size.width * 0.02, // Scaled padding
        vertical: size.height * 0.009, // Scaled padding
      ),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12),
