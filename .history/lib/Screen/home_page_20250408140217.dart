              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(
                      top: size.height * 0.02), // 2% of screen height
                  child: Container(
                    width: size.width * 0.4, // 90% of screen width
                    height: size.height * 0.19, // 25% of screen height
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(100.0),
                      color: const Color.fromARGB(255, 143, 200, 213),
                    ),
                    child: Positioned(
                      top: size.height * 0.04, // 8% of screen height
                      left: size.width * 0.135, // 14% of screen width
                      child: Image.asset(
                        'images/bot1.png',
                        width: size.width * 0.01, // Scaled image size
                      ),
                    ),
                  ),
                ),
