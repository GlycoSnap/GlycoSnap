...
// Function to send image to backend Future _sendImage() async { if (_image == null && _messages.isEmpty) { setState(() { _messages.add({ 'type': 'response', 'text': 'Please select an image first.', }); }); return; }