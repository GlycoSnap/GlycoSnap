...
Future<void> _addMeal(BuildContext context, String mealType, String foodName, double glycemicLoad) async {
    try {
      ...
      Navigator.pop(dial;ontext); // Close dialog
      // Navigate to HomePage (optional, if needed)
