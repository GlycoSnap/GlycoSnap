  ...
  void _submitAnswer() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            _isCorrect! ? 'Correct! Great job! 🎉' : 'Incorrect. Try again tomorrow! 😊',
            style: TextStyle(
              fontFamily: 'Poppins',
        ...
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                colorLight.withOpacity(0.3),
                colorDark.withOpacity(0.3),
              ],
          ...
          children: [
                    ...
                    child: Container(
                          ...
                          colors: _submitted
                              ? (isCorrectOption
                                  ...
                                  : (isSelected && !_isCorrect!
                                      ...
                                      : [white.withOpacity(0.8), white]))
                              : (isSelected
                                  ? [colorLight, colorLight.withOpacity(0.7)]
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: _submitted
                              ? white
                              : (_submitted || isSelected ? colorDarkest : colorDark),
                        ),
                        textAlign: TextAlign.center,
                      ),
                    ),
                  ).animate().scale(duration: 400.ms).fadeIn(duration: 400.ms, delay: (100 * index).ms);
                },
              ),
            ),
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: _selectedOption == null || _submitted ? null : _submitAnswer,
                style: ElevatedButton.styleFrom(
                  backgroundColor: colorDark,
                  foregroundColor: white,
