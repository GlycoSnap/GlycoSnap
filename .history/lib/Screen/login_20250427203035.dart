...
class _LoginState extends State<Login> {
  ...
  void initState() {
    super.initState();
    // Remove signOut to preserve existing session
    // Supabase.instance.client.auth.signOut();
    print('Login initState: Checking current session');
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      print('Google sign-in completed, checking user profile...');
      ...
      final profile = await Supabase.instance.client
          ...
          .eq('user_id', user.id)
          .maybeSingle();
      print('Profile check result: $profile');

      if (profile == null) {
        print('No profile found for user ${user.id}, signing out');
      ...
      print('Profile found, navigating to MainScreen');
  ...
  Future<void> _signInWithEmailAndPassword() async {
    ...
    try {
      ...
      if (user == null) {
        print('No user returned after email/password sign-in');
        Get.snackbar(
          'Login Error',
      ...
      print('AuthException during email/password sign-in: ${error.message}');
      Get.snackbar(
        'Login Error',
        error.message,
        snackPosition: SnackPosition.BOTTOM,
