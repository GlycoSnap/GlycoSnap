        ...
        child: Column(
          children: [
            ...
            Stack(
              ...
              children: [
                Container(
                  width: size.height * 0.3, // Slightly larger than bot image
                  height: size.height * 0.27,
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: colorDark.withValues(alpha: 0.1), // Semi-transparent glow
                    boxShadow: [
                      BoxShadow(
                        color: colorDark.withValues(alpha: 1.2), // Glow color
                        blurRadius: 40,
                        spreadRadius: 15,
                      ),
                    ],
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: backgroundColor3.withValues(alpha: 0.1),
                ...
                SizedBox(width: size.width * 0.05), // Space between buttons
                ElevatedButton(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: _sendTextQuery, // Send query on tap
                ), // Functional send icon
                filled: true,
                fillColor: backgroundColor3.withValues(alpha: 0.3),
            ...
            if (_responseMessage.isNotEmpty)
              Container(
                constraints: BoxConstraints(
                  maxHeight: size.height * 0.2, // Limit height to prevent overflow
                ),
            ...
            SizedBox(height: size.height * 0.02), // Extra padding at bottom
          ],
        ),
      ),
    ),
