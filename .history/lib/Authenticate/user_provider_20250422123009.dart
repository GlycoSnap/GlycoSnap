...
class UserProvider with ChangeNotifier {
  ...
  UserProvider() {
    ...
    // Test Firebase User type
    _testFirebaseUser();
  }

  // Diagnostic method to verify User type
  void _testFirebaseUser() {
    try {
      final User? currentUser = FirebaseAuth.instance.currentUser;
      print('Test Firebase User: uid=${currentUser?.uid}, email=${currentUser?.email}');
    } catch (e) {
      print('Test Firebase User error: $e');
    }
  }
