...
FALLBACK_FOOD = {
    "gi": 50,  # Average GI for mixed foods
    "carbs_per_100g": 20  # Average carbs per 100g
}
...
FOOD_DENSITY = {
    "default": 1.0,  # Generic density if specific food unknown
    # Retain specific densities if needed, or fetch dynamically
    "rice": 1.3,
    "ugali": 1.5,
    "kales": 0.2,
    "spinach": 0.2,
...
def predict_glycemic_load():
    try:
        ...
        # Write to temp file for Roboflow
