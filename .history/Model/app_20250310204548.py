...
FOOD_DATA = {
    "beef": {"gi": 0, "carbs_per_100g": 0},  # Beef has negligible carbs
    "kales": {"gi": 15, "carbs_per_100g": 10},  # Example values
    "ugali": {"gi": 70, "carbs_per_100g": 50},  # Example values
    "rice": {"gi": 73, "carbs_per_100g": 28},  # Example values for white rice
