can we modify it such that it prints out what it sees even outside of my food list? cause before I modfied the app.py, it would bring results like "spaghetti" even though that isnt listed in my food list. this is app.,py rn:
