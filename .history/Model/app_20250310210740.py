        ...
        for r in results:
            for box in r.boxes:
                ...
                if class_name in FOOD_DATA:
                    ...
                    portion_size_grams = estimate_portion_size(box.xyxy[0].cpu().numpy(), image_area, class_name)
