...
rf_client = InferenceHTTPClient(
    ...
    api_key=os.getenv("ROBOFLOW_API_KEY", "X9Omw06td1xiNAN9mhTM")  # Updated default
)
...
def predict_glycemic_load():
    try:
        ...
        rf_result = rf_client.run_workflow(
            workspace_name="zawadi",  # Updated
            workflow_id="detect-and-classify",  # Updated
